...
void default_assert_fail_callback() { exit(1); }
...
{
    logger->error_callback = callback;
}

void clogger_set_assert_fail_callback(CLogger* logger, void (*callback)()) { logger->assert_fail_callback = callback; }
